  ...
  function bindCommentActions(list) {
    ...
    list.querySelectorAll('.comment-reply-btn').forEach(function (btn) {
      btn.addEventListener('click', function () {
        ...
        /* Insérer après le bouton répondre */
  ...
  document.addEventListener('click', function (e) {
    ...
    if (e.target.closest('#share-btn')) {
      ...
      if (navigator.share) {
        ...
        ta.select();
        try { document.execCommand('copy'); if (btn) { btn.textContent = '✅ Lien copié !'; setTimeout(function () { btn.textContent = '🔗 Partager'; }, 2200); } } catch (_) {}
